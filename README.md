...
Включаем прибор в розетку, проверяем - загорелись ли индикаторы, включаем подсветку на панели, открываем дверцу, подключаем оба USB-шнура к компьютеру. После этого запускаем программу **MlabScanner**. При запуске программа проверяет, подключен ли прибор и в случае, если ей не удается активировать камеру выдает сообщение об ошибке.
...
Вверху слева показана информация по тесту, в рамках которого производилось тестирование. Ниже - список всех контролей, участвовавших в тесте. По нажатии на один из них, справа появятся ячейки планшетов, соответствующие различным концентрациям антибиотиков.
